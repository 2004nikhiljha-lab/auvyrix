...
export const SERVICES = [
  { ico: 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z', h: 'MOBILE APPS', d: 'Native and cross-platform iOS & Android products built for growth, payments, and retention.', tag: 'iOS & Android' },
  { ico: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z', h: 'WEBSITES', d: 'Premium marketing sites and web platforms that convert — not templates with a new logo.', tag: 'High-converting' },
  { ico: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2', h: 'CUSTOM CRMS', d: 'Pipelines, lead capture, follow-ups, and reporting designed around how your team actually sells.', tag: 'Sales-ready' },
  { ico: 'M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5', h: 'CUSTOM SOFTWARE', d: 'Internal tools, portals, and workflows that replace spreadsheets and disconnected vendors.', tag: 'Bespoke' },
  { ico: 'M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4zM3 6h18M16 10a4 4 0 01-8 0', h: 'E-COMMERCE', d: 'Storefronts, catalogues, inventory, and checkout flows built to take orders at scale.', tag: 'Commerce' },
  { ico: 'M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z', h: 'ERP / OPERATIONS', d: 'Operations software that connects finance, inventory, field teams, and leadership dashboards.', tag: 'Ops layer' },
  { ico: 'M12 2a4 4 0 014 4v1a4 4 0 01-8 0V6a4 4 0 014-4zM4 14a8 8 0 0016 0', h: 'AI & AUTOMATION', d: 'Agents, document workflows, and automations that remove repetitive work from your business.', tag: 'AI-ready' },
  { ico: 'M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z', h: 'UI / UX DESIGN', d: 'Product design that feels premium on first glance and obvious on first use.', tag: 'Design system' },
]
...
export const WORK = [
  ...
  },
  {
    ...
    img: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&w=1200&q=85',
  },
  {
    client: 'Orbit Retail',
